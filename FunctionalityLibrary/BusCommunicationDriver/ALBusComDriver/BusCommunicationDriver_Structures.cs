...
namespace ALBusComDriver
{
    ...
    public class OffBoardConfig
    {
        ...
        public string TextValue
        {
            get
            {
                return string.Format("ProjectName: {0}; VIT: {1}; EnableByteTrace: {2}; ByteTraceInterfaceName: {3}; LogicalLinks: {4}", 
                    projectName, vit, enableByteTrace, byteTraceInterfaceName, string.Join(", ", logicalLinks));
            }
        }
    }
    ...
    public class OnBoardConfig
    {
        ...
        public string TextValue
        {
            get
            {
                return string.Format("DeviceName:{0}; Bus:{1}{2}; NetCfgFile:{3}; CustomCfgFile:{4}; BusNodes:{5}; LinScheduleTable:{6}; LinMasterNode:{7}; ClusterName:{8}; ContinueOnError:{9}", 
                    deviceName, busType, busChannel, netcCfgFile, customCgfFile, busNodes, linScheduleTable, linMasterNode, clusterName, continueOnError);
            }
        }
    }
    ...
    [Serializable]
    public class OffBoardParallelServices
    {
        private OffBoardService offBoardService;
        private OffBoardResponse offBoardResponse;

        public OffBoardService OffBoardService
        {
            get { return offBoardService; }
            set { offBoardService = value; }
        }

        public OffBoardResponse OffBoardResponse
        {
            get { return offBoardResponse; }
            set { offBoardResponse = value; }
        }
    }

    [Serializable]
    public class OffBoardLogicalLinkParallelServices
    {
        private string logicalLink;
        private List<OffBoardParallelServices> offBoardParallelServices;
        ...
        public List<OffBoardParallelServices> OffBoardParallelServices
        {
            get { return offBoardParallelServices; }
            set { offBoardParallelServices = value; }
        }
    }
    ...
    public enum ExecutionState
    {
        ...
        EXECUTION_FAILED,
        EXECUTION_CANCELED,
        EXECUTION_PENDING_INTERMEDIATE_RESULT,
        EXECUTION_NEGATIVE_RESPONSE,
    }
