...
{
    [Serializable]
    public class MultiplyTerm: BinaryTerm
    {
        public MultiplyTerm()
            : base()
        {
        ...
        public MultiplyTerm(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        public override object Evaluate()
        {
            ...
            throw new Exception("MTF Multiply operation isn't supported with given type.");
        }
        ...
        {
            get { return AutomotiveLighting.MTFCommon.MTFIcons.TermMultiply; }
        }
