...
{
    [Serializable]
    public class LogicalAndTerm : BinaryLogicalTerm
    {
        ...
        public LogicalAndTerm(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        {
            get { return AutomotiveLighting.MTFCommon.MTFIcons.TermAnd; }
        }

        public override string Label
        {
            get { return "Logical AND"; }
        }
    }
}
