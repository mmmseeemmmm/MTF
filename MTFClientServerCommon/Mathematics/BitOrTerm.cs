...
{
    [Serializable]
    public class BitOrTerm : BinaryTerm
    {
        public BitOrTerm() 
            : base()
        {
        ...
        public BitOrTerm(SerializationInfo info, StreamingContext context) 
            : base(info, context)
        {
        }
        ...
        public override object Evaluate()
        {
            ...
            throw new Exception("MTF bitwise or operation isn't supported with given type.");
        }
        ...
        {
            get { return AutomotiveLighting.MTFCommon.MTFIcons.TermBitOr; }
        }

        public override string Label
        {
            get { return "Bitwise OR"; }
        }
    }
}
