...
{
    [Serializable]
    public class LessThanTerm : BinaryLogicalTerm
    {
        public LessThanTerm() 
            : base()
        {
        ...
        public LessThanTerm(SerializationInfo info, StreamingContext context) 
            : base(info, context)
        {
        }
        ...
        {
            get { return AutomotiveLighting.MTFCommon.MTFIcons.TermLess; }
        }
