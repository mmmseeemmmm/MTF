...
{
    [Serializable]
    public class GreaterThanTerm : BinaryLogicalTerm
    {
        ...
        public GreaterThanTerm(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        {
            get { return AutomotiveLighting.MTFCommon.MTFIcons.TermGreater; }
        }
