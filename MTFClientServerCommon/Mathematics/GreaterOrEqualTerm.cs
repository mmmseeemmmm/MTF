...
{
    [Serializable]
    public class GreaterOrEqualTerm : BinaryLogicalTerm
    {
        ...
        public GreaterOrEqualTerm(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        {
            get { return AutomotiveLighting.MTFCommon.MTFIcons.TermGreaterOrEqual; }
        }
