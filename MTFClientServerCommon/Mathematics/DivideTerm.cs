...
{
    [Serializable]
    public class DivideTerm : BinaryTerm
    {
        public DivideTerm()
            : base()
        {
        ...
        public DivideTerm(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        public override object Evaluate()
        {
            ...
            throw new Exception("MTF Divide operation isn't supported with given type.");
        }
        ...
        {
            get { return AutomotiveLighting.MTFCommon.MTFIcons.TermDivide; }
        }
