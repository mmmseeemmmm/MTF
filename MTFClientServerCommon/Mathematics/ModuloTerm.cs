...
{
    [Serializable]
    public class ModuloTerm : BinaryTerm
    {
        public ModuloTerm()
            : base()
        {
        ...
        public ModuloTerm(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        {
            get { return AutomotiveLighting.MTFCommon.MTFIcons.TermModulo; }
        }
